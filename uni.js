...
uniswap = require('simple-uniswap-sdk');

const etherTradeExample = async () => {
  const uniswapPair = new uniswap.UniswapPair({
  ...
  const wallet = new ethers.Wallet('7b3e4f29e4172688944da822c03bbcc06453ca3960efeab36bdc4c295fb761dc', provider);
